...
function seed() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const dealer = (yield User_1.default.findOne({ roles: "dealer" })) || (yield User_1.default.findOne());
            if (!dealer) {
            ...
            const carsToInsert = SAMPLE_CARS.map(car => (Object.assign(Object.assign({}, car), { dealer_id: dealer._id })));
            yield Car_1.default.insertMany(carsToInsert);
